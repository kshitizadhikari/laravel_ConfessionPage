    ...
    <div class="bg-white border-gray">
      <div class="row">
        <div class="col">
          ...
          <input type="text" class="w-75 border-gray text-gray-dark rounded-pill bg-light ps-2 text-start" value="what do you want to share?">
      ...
      <div class="post-footer pt-3 py-4 d-flex align-items-center">
        <div class="btn-group " role="group">
          <button type="button" class="left-btn post-btn bg-secondary-color border-0 text-black p-1">
            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="16" fill="currentColor" class="bi bi-share-fill" viewBox="0 0 16 16">
              <path d="M11 2.5a2.5 2.5 0 1 1 .603 1.628l-6.718 3.12a2.499 2.499 0 0 1 0 1.504l6.718 3.12a2.5 2.5 0 1 1-.488.876l-6.718-3.12a2.5 2.5 0 1 1 0-3.256l6.718-3.12A2.5 2.5 0 0 1 11 2.5z"/>
            </svg>
          </button>
          <button type="button" class="right-btn post-btn bg-secondary-color border-0 text-black p-1">
            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="16" fill="currentColor" class="bi bi-reply-fill" viewBox="0 0 16 16">
