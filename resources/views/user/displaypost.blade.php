                ...
                <div class="posts">
                    ...
                    <div class="post bg-gray border-gray shadow-lg mt-4">
                        ...
                        <div class="post-image pt-2">
                            ...
                            <img src="{{url('public/uploads/'.$image)}}" value="{{url('public/uploads/'.$image)}}"
                                data-id="{{url('public/uploads/'.$image)}}" data-bs-toggle="modal"
                                data-bs-target="#displayimg" class="img-fluid w-100 h-100 gallery-items" alt=""
                        ...
                        <span class="likeform">
                            ...
                            <button type="submit" class="left-btn post-btn bg-transparent border-0 text-black p-4">
                                @php
                                ...
                                @if($postlike->count()>0)
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" id="postdis"
                                    fill="lightblue" class="bi bi-heart-fill" viewBox="0 0 16 16">
                                    <path
                        ...
                        <button type="button" class="  bg-transparent  border-0 ms-2 text-black p-1">
                        ...
                        <button type="submit"
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" class="reportdis"
                                fill="lightblue" class="bi bi-flag-fill" viewBox="0 0 16 16">
                                <path
                        ...
                        <button type="submit"
                            class="report-btn  bg-transparent  border-0 ms-2 text-black p-1 my-modal-trigger"
                            value="{{$post['id']}}" data-id="{{$post['id']}}" data-bs-toggle="modal"
                        ...
                        @endif
                        <small class="ms-4 text-body  mt-1"><svg xmlns="http://www.w3.org/2000/svg" width="13"
                                height="13" fill="currentColor" class="bi me-1 bi-clock" viewBox="0 0 16 16">
                                <path
                    ...
                    <div class="comment h-80">
                        ...
                        <div class="flex items-center justify-center shadow-lg my-5">
                            <form action="{{route('comment')}}" method="post" enctype="multipart/form-data"
                                class="w-full max-w-xl bg-gray rounded-lg px-4  pb-4">
                                @csrf
                                <div class="flex flex-wrap -mx-3 mv-6">
                                    ...
                                    <div class="w-full md:w-full px-3 mb-2 mt-2">
                                        ...
                                        <textarea
                                            class="bg-gray-100 rounded border-gray-400 leading-normal w-100 h-20 py-2 px-3 font-medium placeholder-gray-700 focus:outline-none focus:bg-white border border-secondary"
                                            placeholder="type your comment" name="comment" required></textarea>
                                    </div>
                                    <div class="-mr-1">

                                        <input type="submit"
                                            class="bg-white text-gray-700 font-medium py-1 px-4  border border-gray-400 rounded-lg tracking-wide mr-1 ms-3"
                                            value="Post comment">
                                    </div>
                                </div>
                        ...
                        <div class=" comment-container shadow-lg pt-1 pb-2 mb-3"
                            style="border:1px solid rgba(0,0,0,0.3); border-radius:0.5rem;">
                            <div class="comment-card">
                                <div class="comment-title">
                                    <img src="{{asset($commentusername->img)}}" class="post-profile rounded-circle"
                                        alt="">

                                    <strong>{{$commentusername->username}}</strong>
                                    <small class="ms-4 text-body"><svg xmlns="http://www.w3.org/2000/svg" width="13"
                                            height="13" fill="currentColor" class="bi bi-clock me-1"
                                            viewBox="0 0 16 16">
                                            <path
                                                d="M8 3.5a.5.5 0 0 0-1 0V9a.5.5 0 0 0 .252.434l3.5 2a.5.5 0 0 0 .496-.868L8 8.71V3.5z" />
                                            <path
                                ...
                                <div class="comment-footer d-flex gap-2 fs-6 justify-content-end p-2 me-3 ">
                                    ...
                                    <div class="btn btn-transparent p-0"
                                        onclick="reply('{{$comment->id}}','{{$commentusername->username}}')">Reply</div>
                                    <div class="">

                                        <button type="submit"
                                            class=" bg-transparent  border-0 ms-2 text-black p-0 my-modal-trigger"
                                            value="{{$comment->id}}" data-id="{{$comment->id}}" data-bs-toggle="modal"
                                            data-bs-target="#Modalreportcomm">
                        ...
                        <div class=" comment-container shadow-lg pt-1 pb-2 ms-5 mb-3"
                            style="border:1px solid rgba(0,0,0,0.3); border-radius:0.5rem;">
                            <div class="comment-card">
                                <div class="comment-title">
                                ...
                                <div class="comment-footer d-flex gap-2 fs-6 justify-content-end p-2 me-3 ">
                                    ...
                                    <div class="btn btn-transparent p-0"
                                        onclick="reply('{{$comment->id}}','{{$reply->user->username}}')">Reply</div>

                                    <button type="submit"
                                        class=" bg-transparent  border-0 ms-2 text-black p-0 my-modal-trigger"
                                        value="{{$reply->id}}" data-id="{{$reply->id}}" data-bs-toggle="modal"
                                        data-bs-target="#Modalreportreply">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                            fill="currentcolor" class="bi bi-flag-fill" viewBox="0 0 16 16">
                                            <path
                                                d="M14.778.085A.5.5 0 0 1 15 .5V8a.5.5 0 0 1-.314.464L14.5 8l.186.464-.003.001-.006.003-.023.009a12.435 12.435 0 0 1-.397.15c-.264.095-.631.223-1.047.35-.816.252-1.879.523-2.71.523-.847 0-1.548-.28-2.158-.525l-.028-.01C7.68 8.71 7.14 8.5 6.5 8.5c-.7 0-1.638.23-2.437.477A19.626 19.626 0 0 0 3 9.342V15.5a.5.5 0 0 1-1 0V.5a.5.5 0 0 1 1 0v.282c.226-.079.496-.17.79-.26C4.606.272 5.67 0 6.5 0c.84 0 1.524.277 2.121.519l.043.018C9.286.788 9.828 1 10.5 1c.7 0 1.638-.23 2.437-.477a19.587 19.587 0 0 0 1.349-.476l.019-.007.004-.002h.001" />
                        ...
                        <div class="reply shadow-lg p-2 mb-4" id="reply-form-{{$comment->id}}" style="display:none;">
                            ...
                            <form action="{{route('replies',$comment->id)}}" method="post"
            ...
            <div class="col">
                <ul class="list-group shadow-lg mt-4">
                    ...
                    <li class="list-group-item d-flex">
                        <div class="">
                            <img src="{{asset($postuserimg->img)}}" height="30" width="30" class="rounded" alt=""
                                srcset="">
                        </div>
                        <div class="ps-2">
